...
if ( $tracking_items ) : ?>
	<h2><?php echo apply_filters( 'woocommerce_shipment_tracking_my_orders_title', __( 'Tracking-Nummer folgen.', 'woocommerce-shipment-tracking' ) ); ?></h2>
	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%;" border="1">
		...
		<thead>
			<tr>
				...
				<th class="tracking-number" scope="col" class="td" style="text-align: left; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; color: #737373; border: 1px solid #e4e4e4; padding: 12px;"><?php _e( 'Tracking-Nummer', 'woocommerce-shipment-tracking' ); ?></th>
				<th class="date-shipped" scope="col" class="td" style="text-align: left; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; color: #737373; border: 1px solid #e4e4e4; padding: 12px;"><?php _e( 'Datum', 'woocommerce-shipment-tracking' ); ?></th>
				<th class="order-actions" scope="col" class="td" style="text-align: left; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; color: #737373; border: 1px solid #e4e4e4; padding: 12px;"><?php _e( 'folgen', 'woocommerce-shipment-tracking' ); ?></th>
			</tr>
		</thead>
		...
		foreach ( $tracking_items as $tracking_item ) {
				?><tr class="tracking">
					<td class="tracking-provider" data-title="<?php _e( 'Provider', 'woocommerce-shipment-tracking' ); ?>" style="text-align: left; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; color: #737373; border: 1px solid #e4e4e4; padding: 12px;">
						<?php if($tracking_item['formatted_tracking_provider'] == 'DHL'){  ?>
						<h5 style="font-size:18px;margin:0px;">DHL</h5>
						<img  src="https://www.brieftaubenshop.de/wp-content/uploads/2020/07/dhl_new.png">
						<?php }  ?>
					</td>
