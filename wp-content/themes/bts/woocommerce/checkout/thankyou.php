...
<div class="row">
    ...
    <?php do_action( 'woocommerce_thankyou', $get_order_id ); ?>
		...
		<h2 style="background: #0a4a7c; padding: 0px; margin: 30px 0; text-align: center" class="thanks-back">
		    <a style="color: #fff; text-transform: uppercase; font-size: 25px; width: 100%; padding: 10px; display: block;" href="/produktkategorie/">Zurück zum Shop</a>
		</h2>
